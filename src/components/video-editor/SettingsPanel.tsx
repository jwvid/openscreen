...
interface SettingsPanelProps {
	...
	onCursorClickDarkenChange?: (darken: number) => void;
													...
													<>
														...
														<div className="grid grid-cols-2 gap-2">
															...
															<div className="col-span-2 p-2 rounded-lg bg-white/5 border border-white/5">
																<div className="flex items-center justify-between mb-1">
																	<div className="text-[10px] font-medium text-slate-300">
																		{t("cursor.clickDarken")}
																	</div>
																	<span className="text-[10px] text-slate-500 font-mono">
																		{Math.round(cursorClickDarken * 100)}%
																	</span>
																</div>
																<Slider
																	value={[cursorClickDarken]}
																	onValueChange={(values) => onCursorClickDarkenChange?.(values[0])}
																	min={0}
																	max={1}
																	step={0.01}
																	className="w-full [&_[role=slider]]:bg-[#34B27B] [&_[role=slider]]:border-[#34B27B] [&_[role=slider]]:h-3 [&_[role=slider]]:w-3"
